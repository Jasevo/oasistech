  ...
  return (
    <div className="space-y-5">
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        <div className="h-1 bg-gradient-to-r from-[#092421] via-[#1a5c47] to-[#e3ba54]" />
        <div className="px-6 py-5 flex items-center gap-4">
          <div className="w-11 h-11 rounded-xl bg-[#092421] flex items-center justify-center shrink-0 shadow-sm">
            <BarChart3 className="w-5 h-5 text-[#e3ba54]" />
          </div>
          <div>
